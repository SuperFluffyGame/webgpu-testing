import { device, format, context, canvas, canvas2context, canvas2, mouseImage, mouseCanvasContext, } from "./init.js";
...
export function render(timestamp) {
    ...
    let col = mouseCanvasContext?.getImageData(mouseOffset.x, mouseOffset.y, 1, 1).data;
    if (col[0] === 255) {
